...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"D:\\Denys\\Desktop\\nuxt-conf\\.data\\kv"}));
...
const _LQlZ11vAKU = defineNitroPlugin(() => {
...
const _vEkrSPCRUA = (function(nitro) {
...
const collections = {
  'carbon': () => import('./icons.mjs').then(m => m.default),
  'heroicons': () => import('./icons2.mjs').then(m => m.default),
  'logos': () => import('./icons3.mjs').then(m => m.default),
  'ri': () => import('./icons4.mjs').then(m => m.default),
  'tabler': () => import('./icons5.mjs').then(m => m.default),
};

const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _SYNy0o = defineCachedEventHandler(async (event) => {
...
const _UQKGBr = lazyEventHandler(() => {
...
const _lazy_nVcmhT = () => import('../routes/api/chat.post.mjs');
const _lazy_jhq5zx = () => import('../routes/api/deleteUser.delete.mjs');
const _lazy_jsCZAL = () => import('../routes/api/getScans.get.mjs');
const _lazy_3ogsCZ = () => import('../routes/api/login.post.mjs');
const _lazy_rOPDrL = () => import('../routes/api/saveScan.post.mjs');
const _lazy_PQtV4N = () => import('../routes/api/user.post.mjs');
const _lazy_L7wSg4 = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/chat', handler: _lazy_nVcmhT, lazy: true, middleware: false, method: "post" },
  { route: '/api/deleteUser', handler: _lazy_jhq5zx, lazy: true, middleware: false, method: "delete" },
  { route: '/api/getScans', handler: _lazy_jsCZAL, lazy: true, middleware: false, method: "get" },
  { route: '/api/login', handler: _lazy_3ogsCZ, lazy: true, middleware: false, method: "post" },
  { route: '/api/saveScan', handler: _lazy_rOPDrL, lazy: true, middleware: false, method: "post" },
  { route: '/api/user', handler: _lazy_PQtV4N, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_L7wSg4, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _SYNy0o, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _UQKGBr, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_L7wSg4, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withLeadingSlash as A, parseURL as B, encodePath as C, parse as D, getRequestHeader as E, destr as F, getCookie as G, deleteCookie as H, defineRenderHandler as I, buildAssetsURL as J, publicAssetsURL as K, getRouteRules as L, getResponseStatus as M, getResponseStatusText as N, useNitroApp as O, toNodeListener as P, defuFn as a, baseURL as b, createError$1 as c, defineEventHandler as d, defu as e, sanitizeStatusCode as f, getQuery as g, hasProtocol as h, isScriptProtocol as i, joinURL as j, klona as k, createDefu as l, getContext as m, createHooks as n, withTrailingSlash as o, parseQuery as p, withoutTrailingSlash as q, readBody as r, setCookie as s, toRouteMatcher as t, useRuntimeConfig as u, createRouter$1 as v, withQuery as w, isEqual as x, encodeParam as y, diff as z };
