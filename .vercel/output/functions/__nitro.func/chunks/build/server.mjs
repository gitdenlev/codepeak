import { version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineAsyncComponent, defineComponent, provide, shallowReactive, h, inject, Suspense, nextTick, Fragment, Transition, hasInjectionContext, unref, resolveComponent, useSSRContext, createApp, effectScope, reactive, getCurrentScope, computed, mergeProps, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, shallowRef, isReadonly, toRaw, isShallow, isReactive } from 'vue';
import { $ as $fetch$1, b as baseURL, h as hasProtocol, i as isScriptProtocol, j as joinURL, w as withQuery, c as createError$1, a as defuFn, k as klona, e as defu, f as sanitizeStatusCode, p as parseQuery, l as createDefu, m as getContext, n as createHooks, o as withTrailingSlash, q as withoutTrailingSlash, t as toRouteMatcher, v as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CLOLAtsC.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-YxmlJSmV.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-BOaJcPU3.mjs')
  }
];
const _wrapIf = (component, props, slots) => {
  ...
  return { default: () => {
    var _a2;
    return props ? h(component, props, slots) : (_a2 = slots.default) == null ? undefined : _a2.call(slots);
  } };
};
...
const namedMiddleware = {
  auth: () => import('./auth-l0sNRNKZ.mjs').then(function (n) { return n.a; })
};
...
const LazyIcon = defineAsyncComponent(() => import('./index-1YXbR_pY.mjs').then((r) => r["default"] || r.default || r));
...
}, (_a = appConfig.ui) == null ? undefined : _a.tailwindMerge));
...
const plugin_WLsn00x1qh = /* @__PURE__ */ defineNuxtPlugin({
  ...
  setup() {
    ...
    if (options.provider === "server") {
      const baseURL2 = ((_b = (_a2 = configs.app) == null ? undefined : _a2.baseURL) == null ? undefined : _b.replace(/\/$/, "")) ?? "";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "error-container" }, _attrs))} data-v-9f17b041><div class="error-code" data-v-9f17b041>${ssrInterpolate(__props.error.statusCode)}</div><h2 class="message" data-v-9f17b041>${ssrInterpolate(__props.error.message)}</h2><div class="cta-container" data-v-9f17b041>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="cta-text" data-v-9f17b041${_scopeId}>Return to safety</span><span class="cta-icon" data-v-9f17b041${_scopeId}>→</span>`);
          } else {
            return [
              createVNode("span", { class: "cta-text" }, "Return to safety"),
              createVNode("span", { class: "cta-icon" }, "→")
            ];
          }
        }),
        _: 1
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-9f17b041"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export { __nuxt_component_1 as _, useRouter as a, useNuxtApp as b, useState as c, asyncDataDefaults as d, entry$1 as default, createError as e, useAppConfig as f, useRuntimeConfig as g, _export_sfc as h, get as i, appConfig as j, mergeConfig as m, navigateTo as n, omit as o, twMerge as t, useHead as u };
