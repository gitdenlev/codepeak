...
import { u as useHead, a as useRouter, _ as __nuxt_component_1 } from './server.mjs';
...
import { u as useAuth } from './useAuth-6QbkkPW4.mjs';
import '@iconify/vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1 class="text-2xl">codepeak</h1></div><form class="w-full max-w-md"><div class="flex flex-col gap-4 items-center"><div class="relative w-2/3 text-black/70"><input${ssrRenderAttr("value", unref(email))} type="email" placeholder="Email address" required class="font-sans placeholder:font-kanit overflow-x-scroll pl-10 pr-4 py-2 rounded-md border-none outline-none border-gray-300 w-full">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ic:twotone-alternate-email",
        size: "20",
        class: "absolute left-3 top-1/2 -translate-y-1/2"
      }, null, _parent));
      _push(`</div><div class="relative w-2/3 text-black/70"><input${ssrRenderDynamicModel(unref(isShowPassword) ? "text" : "password", unref(password), null)}${ssrRenderAttr("type", unref(isShowPassword) ? "text" : "password")} placeholder="Password" required class="font-sans placeholder:font-kanit overflow-x-scroll pl-10 pr-10 py-2 rounded-md border-none outline-none border-gray-300 w-full">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:password",
        size: "20",
        class: "absolute left-3 top-1/2 -translate-y-1/2"
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Don&#39;t have an account? Sign up here `);
          } else {
            return [
              createTextVNode(" Don't have an account? Sign up here ")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=login-YxmlJSmV.mjs.map
